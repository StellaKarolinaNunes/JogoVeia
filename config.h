...
// Remoção de macros não utilizadas
...
typedef struct {
  ...
  int historicoJogadasX[3]; // Armazena as 3 últimas posições de X (Modo
                            // Infinito)
  int historicoJogadasO[3]; // Armazena as 3 últimas posições de O (Modo
                            // Infinito)
  int numJogadasX;
  int numJogadasO;
